    ...
    private void inicializarLista() {
    	...
    	while(i <= app.getCompradores().size()) {
    		if(app.getCompradores().get(i) != null) {		    	
		    	String view = app.getCompradores().get(i).getIdComprador() + " | " + app.getCompradores().get(i).getNombre() + " | " + app.getCompradores().get(i).getApellidos() + " | " +  app.getCompradores().get(i).getApellidos() + " | " + app.getCompradores().get(i).getNUsuario() + " | " + app.getCompradores().get(i).getEmail() + " | " + app.getCompradores().get(i).getTelefono();	    			
